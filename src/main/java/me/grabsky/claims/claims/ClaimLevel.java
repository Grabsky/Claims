...
public class ClaimLevel {
    ...
    public static final ClaimLevel EMERALD = new ClaimLevel.Builder(5)
            ...
            .setInventoryIcon(new ItemBuilder(Material.PLAYER_HEAD)
                    .setName("§a§lUlepsz")
                    .setLore("", "§7Obecny poziom: §aSzmaragd", "§8› §7Rozmiar: §a71x71", "", "§7Następny poziom: §8Netherite", "§8› §7Rozmiar: §881x81", "", "§7Koszt ulepszenia:", "§8› §d1x Kryształ Ulepszenia", "§8› §84x Netheryt", "")
